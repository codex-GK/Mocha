...
//json object to string-->using strigify method(); string to javascript object using parse method()
const dataset = JSON.parse(
  JSON.stringify(require("../Utils/pageObjectImpTestData.json"))
);
//for(const data of dataset) this will help to iterate the data set from the array
for (const data of dataset) {
  //${} this will evaluate as expression if not is is considered as a regular string
  //${} allows to insert values directly into string
